...
const defaultFaqs: FaqItem[] = [
	{
		...
		answer:
			"YieldEDU generates yields by integrating with DeFi protocols and decentralized exchanges (DEXs). When investors fund learning, their contributions are deployed into these strategies to generate real, on-chain returns. A portion of the yields is used to reward learners, while investors receive their principal plus earnings. This ensures both parties benefit directly, making the model sustainable and mutually rewarding.",
	},
	{
	...
	},
	{
		...
		answer:
			"We believe people stay where value is created. YieldEDU combines real rewards, gamified learning (quizzes, sTokens, points), leaderboards and community-driven features turning education into a habit with tangible value.",
	},
];
