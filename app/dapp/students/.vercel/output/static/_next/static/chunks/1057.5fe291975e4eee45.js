"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[1057],{4537:(e,t,o)=>{var i=o(28312),r=o(745),a=o(97265),s=o(54166);let n=(0,i.AH)`
  :host {
    display: flex;
  }
...
`;var c=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};let l=class extends i.WF{constructor(){super(...arguments),this.color="accent-100",this.size="lg"}render(){return this.style.cssText=`--local-color: ${"inherit"===this.color?"inherit":`var(--wui-color-${this.color})`}`,this.dataset.size=this.size,(0,i.qy)`<svg viewBox="25 25 50 50">
    ...
    </svg>`}};l.styles=[a.W5,n],c([(0,r.MZ)()],l.prototype,"color",void 0),c([(0,r.MZ)()],l.prototype,"size",void 0),l=c([(0,s.E)("wui-loading-spinner")],l)},13998:(e,t,o)=>{o(48252)},15127:(e,t,o)=>{var i=o(28312),r=o(745);o(4537),o(98750);var a=o(97265),s=o(54166);let n=(0,i.AH)`
  :host {
...
`;var c=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};let l={main:"inverse-100",inverse:"inverse-000",accent:"accent-100","accent-error":"error-100","accent-success":"success-100",neutral:"fg-100",disabled:"gray-glass-020"},d={lg:"paragraph-600",md:"small-600",sm:"small-600",xs:"tiny-600"},u={lg:"md",md:"md",sm:"sm",xs:"sm"},h=class extends i.WF{constructor(){super(...arguments),this.size="lg",this.disabled=!1,this.fullWidth=!1,this.loading=!1,this.variant="main",this.hasIconLeft=!1,this.hasIconRight=!1,this.borderRadius="m"}render(){this.style.cssText=`
    ...
    `}handleSlotLeftChange(){this.hasIconLeft=!0}handleSlotRightChange(){this.hasIconRight=!0}loadingTemplate(){if(this.loading){let e=u[this.size],t=this.disabled?l.disabled:l[this.variant];return(0,i.qy)`<wui-loading-spinner color=${t} size=${e}></wui-loading-spinner>`}return(0,i.qy)``}};h.styles=[a.W5,a.fD,n],c([(0,r.MZ)()],h.prototype,"size",void 0),c([(0,r.MZ)({type:Boolean})],h.prototype,"disabled",void 0),c([(0,r.MZ)({type:Boolean})],h.prototype,"fullWidth",void 0),c([(0,r.MZ)({type:Boolean})],h.prototype,"loading",void 0),c([(0,r.MZ)()],h.prototype,"variant",void 0),c([(0,r.MZ)({type:Boolean})],h.prototype,"hasIconLeft",void 0),c([(0,r.MZ)({type:Boolean})],h.prototype,"hasIconRight",void 0),c([(0,r.MZ)()],h.prototype,"borderRadius",void 0),c([(0,r.MZ)()],h.prototype,"textVariant",void 0),h=c([(0,s.E)("wui-button")],h)},23050:(e,t,o)=>{var i=o(28312),r=o(745);o(23499);var a=o(97265),s=o(54166);let n=(0,i.AH)`
  :host {
    display: flex;
...
`;var b=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};let f=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.tabIdx=void 0,this.connectors=l.a.state.connectors,this.authConnector=this.connectors.find(e=>"AUTH"===e.type),this.remoteFeatures=n.H.state.remoteFeatures,this.isPwaLoading=!1,this.unsubscribe.push(l.a.subscribeKey("connectors",e=>{this.connectors=e,this.authConnector=this.connectors.find(e=>"AUTH"===e.type)}),n.H.subscribeKey("remoteFeatures",e=>this.remoteFeatures=e))}connectedCallback(){super.connectedCallback(),this.handlePwaFrameLoad()}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let e=this.remoteFeatures?.socials||[],t=!!this.authConnector,o=e?.length,r="ConnectSocials"===d.I.state.view;return t&&o||r?(r&&!o&&(e=u.oU.DEFAULT_SOCIALS),(0,i.qy)` <wui-flex flexDirection="column" gap="xs">
      ${e.map(e=>(0,i.qy)`<wui-list-social
          ...
          ></wui-list-social>`)}
    </wui-flex>`):null}async onSocialClick(e){e&&await (0,p.Up)(e)}async handlePwaFrameLoad(){if(g.w.isPWA()){this.isPwaLoading=!0;try{this.authConnector?.provider instanceof w.Y&&await this.authConnector.provider.init()}catch(e){h.h.open({shortMessage:"Error loading embedded wallet in PWA",longMessage:e.message},"error")}finally{this.isPwaLoading=!1}}}};f.styles=v,b([(0,r.MZ)()],f.prototype,"tabIdx",void 0),b([(0,r.wk)()],f.prototype,"connectors",void 0),b([(0,r.wk)()],f.prototype,"authConnector",void 0),b([(0,r.wk)()],f.prototype,"remoteFeatures",void 0),b([(0,r.wk)()],f.prototype,"isPwaLoading",void 0),f=b([(0,c.EM)("w3m-social-login-list")],f);let x=(0,i.AH)`
  wui-flex {
...
`;var y=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};let m=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.checked=s.o.state.isLegalCheckboxChecked,this.unsubscribe.push(s.o.subscribeKey("isLegalCheckboxChecked",e=>{this.checked=e}))}disconnectedCallback(){this.unsubscribe.forEach(e=>e())}render(){let{termsConditionsUrl:e,privacyPolicyUrl:t}=n.H.state,o=n.H.state.features?.legalCheckbox,r=!!(e||t)&&!!o,s=r&&!this.checked;return(0,i.qy)`
    ...
    `}};m.styles=x,y([(0,r.wk)()],m.prototype,"checked",void 0),m=y([(0,c.EM)("w3m-connect-socials-view")],m);var k=o(11076),C=o(14796),$=o(90906),P=o(32836),E=o(5582),S=o(5517),R=o(33806),I=o(7478);o(36698),o(19284),o(23050),o(22724);var W=o(28307),z=o(26128);let O=(0,i.AH)`
  wui-logo {
    width: 80px;
    height: 80px;
...
`;var q=function(e,t,o,i){var r,a=arguments.length,s=a<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(e,t,o,i);else for(var n=e.length-1;n>=0;n--)(r=e[n])&&(s=(a<3?r(s):a>3?r(t,o,s):r(t,o))||s);return a>3&&s&&Object.defineProperty(t,o,s),s};let M=class extends i.WF{constructor(){super(),this.unsubscribe=[],this.timeout=void 0,this.socialProvider=k.U.state.socialProvider,this.uri=k.U.state.farcasterUrl,this.ready=!1,this.loading=!1,this.remoteFeatures=n.H.state.remoteFeatures,this.authConnector=l.a.getAuthConnector(),this.forceUpdate=()=>{this.requestUpdate()},this.unsubscribe.push(k.U.subscribeKey("farcasterUrl",e=>{e&&(this.uri=e,this.connectFarcaster())}),k.U.subscribeKey("socialProvider",e=>{e&&(this.socialProvider=e)}),n.H.subscribeKey("remoteFeatures",e=>{this.remoteFeatures=e})),window.addEventListener("resize",this.forceUpdate)}disconnectedCallback(){super.disconnectedCallback(),clearTimeout(this.timeout),window.removeEventListener("resize",this.forceUpdate)}render(){return this.onRenderProxy(),(0,i.qy)`${this.platformTemplate()}`}platformTemplate(){return g.w.isMobile()?(0,i.qy)`${this.mobileTemplate()}`:(0,i.qy)`${this.desktopTemplate()}`}desktopTemplate(){return this.loading?(0,i.qy)`${this.loadingTemplate()}`:(0,i.qy)`${this.qrTemplate()}`}qrTemplate(){return(0,i.qy)` <wui-flex
    ...
    </wui-flex>`}loaderTemplate(){let e=I.W.state.themeVariables["--w3m-border-radius-master"],t=e?parseInt(e.replace("px",""),10):4;return(0,i.qy)`<wui-loading-thumbnail radius=${9*t}></wui-loading-thumbnail>`}async connectFarcaster(){if(this.authConnector)try{await this.authConnector?.provider.connectFarcaster(),this.socialProvider&&(E.i.setConnectedSocialProvider(this.socialProvider),P.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_REQUEST_USER_DATA",properties:{provider:this.socialProvider}})),this.loading=!0;let e=C.x.getConnections(this.authConnector.chain).length>0;await C.x.connectExternal(this.authConnector,this.authConnector.chain);let t=this.remoteFeatures?.multiWallet;this.socialProvider&&P.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_SUCCESS",properties:{provider:this.socialProvider}}),this.loading=!1,e&&t?(d.I.replace("ProfileWallets"),S.P.showSuccess("New Wallet Added")):R.W.close()}catch(e){this.socialProvider&&P.E.sendEvent({type:"track",event:"SOCIAL_LOGIN_ERROR",properties:{provider:this.socialProvider}}),d.I.goBack(),S.P.showError(e)}}mobileLinkTemplate(){return(0,i.qy)`<wui-button
      size="md"
    ...
    >
      ...
      Copy link
    </wui-link>`}onCopyUri(){try{this.uri&&(g.w.copyToClopboard(this.uri),S.P.showSuccess("Link copied"))}catch{S.P.showError("Failed to copy")}}};M.styles=U,q([(0,r.wk)()],M.prototype,"socialProvider",void 0),q([(0,r.wk)()],M.prototype,"uri",void 0),q([(0,r.wk)()],M.prototype,"ready",void 0),q([(0,r.wk)()],M.prototype,"loading",void 0),q([(0,r.wk)()],M.prototype,"remoteFeatures",void 0),M=q([(0,c.EM)("w3m-connecting-farcaster-view")],M)},54279:(e,t,o)=>{o(15127)},74236:(e,t,o)=>{o.d(t,{_:()=>s,K:()=>l});var i=o(77508),r=o(27543),a=o(11886);let s=()=>new n;class n{}let c=new WeakMap,l=(0,a.u$)(class extends r.Kq{render(e){return i.s6}update(e,[t]){let o=t!==this.G;return o&&void 0!==this.G&&this.rt(void 0),(o||this.lt!==this.ct)&&(this.G=t,this.ht=e.options?.host,this.rt(this.ct=e.element)),i.s6}rt(e){if(this.isConnected||(e=void 0),"function"==typeof this.G){let t=this.ht??globalThis,o=c.get(t);void 0===o&&(o=new WeakMap,c.set(t,o)),void 0!==o.get(this.G)&&this.G.call(this.ht,void 0),o.set(this.G,e),void 0!==e&&this.G.call(this.ht,e)}else this.G.value=e}get lt(){return"function"==typeof this.G?c.get(this.ht??globalThis)?.get(this.G):this.G?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}})},89188:(e,t,o)=>{var i=o(28312),r=o(745),a=o(51882);o(98750);var s=o(97265),n=o(54166);o(23050);let c=(0,i.AH)`
  button {
