...
async function main() {
	...
	const deploymentsPath = path.join(
		__dirname,
		"../../apps/dapp/investors/mainnet-deployments/deployments.json"
	);

	const deploymentsPath2 = path.join(
		__dirname,
		"../../apps/ponder/mainnet-deployments/deployments.json"
	);
	...
	const abiDir = path.join(
		__dirname,
		"../../apps/dapp/investors/mainnet-deployments/abis"
	);
	const abiDir2 = path.join(
		__dirname,
		"../../apps/ponder/mainnet-deployments/abis"
	);
